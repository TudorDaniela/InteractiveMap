...
- Create Angular project with ng: `ng new interactivemap.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`interactivemap.client.esproj`).
